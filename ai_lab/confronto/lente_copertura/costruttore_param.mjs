...
import { regimeNeutralizzato, passoUtilizzabile } from '../../../simulatore/provenienza/definizioni.mjs';
import { simboliStatus, MESCOLE_SLICK } from '../../../simulatore/provenienza/vocabolario.mjs';
...
import { creaPasso, stimaBasi } from '../../../simulatore/engine/passo_v2.mjs';
import { validaSimulazione } from '../../../simulatore/scenario/director.mjs';
...
let MIN_GIRI_BASE = 8;
export function impostaMinGiriBase(n) { MIN_GIRI_BASE = n; }
export function minGiriBase() { return MIN_GIRI_BASE; }
