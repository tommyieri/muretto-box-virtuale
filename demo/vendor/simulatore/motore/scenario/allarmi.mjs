...
// Questo modulo e' PURO (nessun node:fs): `caricaDurate2026` e il percorso
// della vista stanno in allarmi_dati.mjs. Gli allarmi si mostrano anche nel
// pannello live, che gira nel browser.
