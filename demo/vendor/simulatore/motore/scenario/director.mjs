...
// Questo modulo e' PURO (nessun node:fs): `caricaCostanti` sta in
// director_dati.mjs. Il guardiano gira anche nel browser, sotto il pannello
// live, e un import dal disco qui lo renderebbe non caricabile.
