...
def main():
    ...
    P("- SEGNO: SOFT/MEDIUM positivi, HARD negativo (-0,162). Il valore HARD negativo NON e'")
    P("  fisicamente sospetto: e' il valore MISURATO dal progetto (warmin_prior.csv, HARD ~-0,12/")
    P("  -0,20 s), coerente col fatto che la gomma dura scalda diversamente. Correzione al commento")
    P("  precedente: non c'e' anomalia di segno da spiegare.")
    ...
    P("  FEATURE lo conta una seconda volta -> peggiora la")
